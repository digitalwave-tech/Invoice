    ...
    public partial class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=invoicedatabase-01.c16wgaocsmno.us-east-1.rds.amazonaws.com;Database=InvoiceMgmt;User ID=admin;Password=Innovation2024;", sqlServerOptions =>
                {
                    sqlServerOptions.EnableRetryOnFailure(
                        maxRetryCount: 5, // The maximum number of retry attempts
                        maxRetryDelay: TimeSpan.FromSeconds(30), // The maximum delay between retries
                ...
                //optionsBuilder.UseSqlServer("Server=DESKTOP-IP8R4CT;Database=InvoiceMgmt;Trusted_Connection=True;Encrypt=False;", sqlServerOptions =>
                //{
                //    sqlServerOptions.EnableRetryOnFailure(
                //        maxRetryCount: 5, // The maximum number of retry attempts
                //        maxRetryDelay: TimeSpan.FromSeconds(30), // The maximum delay between retries
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Invoices>(entity =>
            {
                ...
                entity.Property(e => e.InvoiceNo).HasColumnName("invoiceNo").ValueGeneratedOnAdd(); 
            ...
            modelBuilder.Entity<ItemsDetails>(entity =>
            {
                ...
                entity.Property(e => e.invoiceNo).HasColumnName("invoiceNo").ValueGeneratedNever(); ;
