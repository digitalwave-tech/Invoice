...
namespace BusinessLayer.Repositories
{
    public class InvoiceRepo : IInvoice
    {
        ...
        public async Task<string> BindInvoice(InvoiceRequest invoiceRequest)
        {
            ...
            Invoices invoices = new Invoices()
            {
                ...
                Details = invoiceRequest.Details.Select(d => new ItemsDetails
                {
                    itemName = d.itemName,
                    quantity = d.quantity,
                    price = d.price,
                                    ...
                                    customerdetails = (
                                        ...
                                        select new Customerdetail
                                        {
                                            ...
                                            itemDetails = groupedCustomers.Select(item => new Itemdetail
                                            {
                                                ...
                                                invocieDate = item.i.InvoiceDate.ToString("dd/MM/yyyy"),
